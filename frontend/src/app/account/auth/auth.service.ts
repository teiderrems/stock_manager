...
export class AuthService {
  ...
  register(credentiels:Register):Observable<any>{
    ...
    let url=this.constantService.getBaseUrl()+"register";
  ...
  forgotPassword(email:string):Observable<any>{
    let url=this.constantService.getBaseUrl()+"forgotPassword";
  ...
  resetPassword(credentiels:ResetPassword):Observable<any>{
    let url=this.constantService.getBaseUrl()+"resetPassword";
    return this.http.post<any>(url,credentiels);
  }
}
